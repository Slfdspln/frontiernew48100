      ...
      <div className="container mx-auto">
        <div
          ...
          <div className="flex gap-0 flex-col justify-between p-6 border rounded-md">
            ...
            <h2
              className="text-4xl tracking-tighter max-w-xl text-left font-regular flex flex-row gap-4 items-end">
              500.000
            ...
            <p
              className="text-base leading-relaxed tracking-tight text-muted-foreground max-w-xl text-left">
