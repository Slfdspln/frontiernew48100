...
const useThree = dynamic(() => import("@react-three/fiber").then(mod => ({ default: mod.useThree })), { ssr: false });
                ...
                {step === "email" ? (
                  <motion.div
                    ...
                    <div className="space-y-1">
                      <h1
                        className="text-[2.5rem] font-bold leading-[1.1] tracking-tight text-white">Welcome to Frontier Tower</h1>
