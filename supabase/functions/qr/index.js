// supabase/functions/qr/index.js
// Frontier Tower Guest Pass QR Code Generator and Validator
...
async function generateToken(payload, expiryHours = 24) {
...
serve(async (req) => {
  ...
  try {
    ...
    if (req.method === "POST" && path === "generate") {
      const { passId, guestName, expiryHours = 24, oneTimeUse = true } = await req.json();
